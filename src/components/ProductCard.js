    ...
    <div className="group flex flex-col glass-card rounded-[2rem] overflow-hidden border-none h-full">
      <div className="relative aspect-square overflow-hidden">
        ...
        <div className="absolute top-4 right-4">
          <span className={`px-3 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-wider backdrop-blur-md shadow-sm border ${product.inStock
        ...
        <div className="mt-auto pt-6 border-t border-border/50">
          ...
          <div className="flex gap-2">
            <Link
              ...
              className="flex-1 flex  items-center justify-center gap-2 glass hover:bg-black/5 dark:hover:bg-white/5 py-3 rounded-2xl transition-all font-bold text-l"
            >
              Детали
            </Link>
