...
export default function ProductCardCarousel({ product }) {
  return (
    <div className="min-h-[480px] sm:h-[550px] flex flex-col justify-around group bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden transform">
      ...
      <div className="p-3 sm:p-4">
        ...
        <div className="flex flex-col justify-between items-start gap-2 sm:gap-0">
          ...
          <div className="flex flex-row justify-between items-stretch gap-2 w-full lg:justify-between h-auto">
            <Link
